...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 18 Apr 2020 pada 05.47
...
CREATE TABLE `tb_hewan` (
  ...
  `Perawatan 1` text DEFAULT NULL,
  `Perawatan 2` text DEFAULT NULL,
  `Perawatan 3` text DEFAULT NULL,
  `Perawatan 4` text DEFAULT NULL
